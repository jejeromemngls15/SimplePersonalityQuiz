...
<body>
    <div class="whiteBox"> 
        ...
        <div class="indexLowerDiv">
            ...
            <p class="disclaimerHome disclaimer"> <% out.print(getServletContext().getInitParameter("disclaimerTag"));%></p>
            ...
            <button onclick="window.location.href='welcomePage2.jsp';" class="modeBtn">Christmas Mode!</button>
